...
export default function FolderComponent({ data }: FolderComponentProps) {
					...
					<div className="p-6 h-full">
						{selectedFile ? (
							!loading ? (
								...
								<div className="flex items-center justify-center h-full">
									<div className="text-center">
										...
										<p className="text-sm text-zinc-500">{t('components.folder.loading')}</p>
									</div>
								</div>
							)
						) : (
							<div className="flex items-center justify-center h-full text-zinc-500">
								<div className="text-center">
									<FileText className="w-12 h-12 mx-auto mb-4 text-zinc-300" />
									<p className="text-sm">{t('components.folder.selectFileToViewContents')}</p>
								</div>
							</div>
						)}
					</div>
