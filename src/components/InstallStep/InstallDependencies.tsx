			...
			return (
				<Dialog open={status === "error"}>
					<DialogContent className="bg-white-100%">
						<DialogHeader>
							<DialogTitle>{t('components.installDependencies.installationFailed')}</DialogTitle>
						</DialogHeader>
						<DialogFooter>
							<Button onClick={handleInstall}>{t('components.installDependencies.retry')}</Button>
							<Button onClick={handleInstall}>{t('components.installDependencies.retry')}</Button>
						</DialogFooter>
					</DialogContent>
				</Dialog>
					...
					<div>
						...
						<div className="flex items-center gap-2 justify-between">
							<div className="text-text-label text-xs font-normal leading-tight ">
								{isInstalling ? t('components.installDependencies.systemInstalling') : ""}
				...
				<DialogContent className="bg-white-100%">
					...
					<DialogFooter>
						...
						>
							...
							{t('components.installDependencies.reportABug')}
						</Button>
						<Button size="sm" onClick={handleInstall}>
							{t('components.installDependencies.retry')}
						</Button>
					</DialogFooter>
				</DialogContent>
			</Dialog>
