...
export const CarouselStep: React.FC = () => {
	...
	const carouselItems = [
		{
			title: t('components.carousel.dynamicWorkforce'),
			video: dynamicWorkforceVideo,
		},
		{
			title: t('components.carousel.addWorkerWithPluggableMcp'),
			video: addWorkerVideo,
		},
		{
			title: t('components.carousel.privateAndSecureWithLocalModel'),
			...
			<div className="flex justify-between items-center gap-sm">
				...
				<div className="flex justify-center items-center gap-sm">
					...
					<Button
						...
						size="sm"
					>
						<div>{t('components.carousel.next')}</div>
