			...
			!isTakeControl ? (
				<div className="mr-2 flex items-center justify-between gap-sm z-50 bg-input-bg-default p-sm rounded-2xl border border-solid border-input-border-default">
					...
					>
						...
						{t('components.bottomInput.replay')}
					</Button>
				</div>
				...
				<div className="mr-2 flex items-center justify-between gap-sm z-50 bg-input-bg-default p-sm rounded-2xl border border-solid border-input-border-default">
					...
					>
						...
						<span className="text-xs leading-tight font-bold">
							{t('components.bottomInput.backToEdit')}
						</span>
					</Button>
					<Button
						disabled={loading}
					...
					>
						<span className="text-xs leading-17 font-medium">
							{loading ? t('components.bottomInput.processing') : t('components.bottomInput.startTask')}
						</span>
			  ...
			  !isTakeControl ? (
					...
					{!(
						...
						>
							...
							<span className="text-button-primary-icon-default text-xs font-semibold leading-17">
								{chatStore.tasks[chatStore.activeTaskId as string].status ===
								"pause"
									? t('components.bottomInput.start')
									: t('components.bottomInput.pause')}
							</span>
						</Button>
					) : (
						<Button
				...
				<div className="mr-2 relative z-10  h-auto min-h-[82px] rounded-2xl bg-input-bg-default !px-2 !pb-2 gap-0 space-x-1 shadow-none border-solid border border-zinc-300">
					<Textarea
						...
						rows={1}
						placeholder={t('components.chatBox.inputPlaceholder')}
						onInput={(e) => {
											...
											attaches.map((item) => (
												...
												>
													...
													<Button
														...
														title={t('components.bottomInput.removeFile')}
													>
					...
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-1">
							<Button
								...
								size="icon"
								className="rounded"
								title={t('components.bottomInput.selectFile')}
							>
								<Paperclip
									size={16}
