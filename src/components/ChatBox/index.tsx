										...
										if (item.step === "end") {
											...
											return (
												<MessageCard
													...
													key={item.id}
													role={item.role}
													content={t('components.chatBox.noReply')}
													onTyping={scrollToBottom}
												/>
											);
										} else {
						...
						<div className="h-[210px] flex justify-center items-start gap-2 mt-3">
								...
								<div className="flex items-center gap-2">
									...
									>
										...
										<span className="text-text-information text-sm font-medium leading-[22px]">
											{t('components.chatBox.setupToStart')}
										</span>
									</div>
								</div>
							) : (
							...
							{privacy && (hasSearchKey || modelType === "cloud") && (
								<div className="mr-2 flex flex-col items-center gap-2">
									{[
										{
											label: t('components.chatBox.tripPlanner'),
											message:
										...
										{
											label: t('components.chatBox.csvAnalysis'),
											message:
										...
										{
											label: t('components.chatBox.findDuplicateFiles'),
											message:
