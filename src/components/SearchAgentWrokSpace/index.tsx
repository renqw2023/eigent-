...
export default function Home() {
	...
	const agentMap = {
		developer_agent: {
			name: t("components.searchAgentWorkspace.developerAgent"),
		...
		search_agent: {
			name: t("components.searchAgentWorkspace.searchAgent"),
		...
		document_agent: {
			name: t("components.searchAgentWorkspace.documentAgent"),
		...
		multi_modal_agent: {
			name: t("components.searchAgentWorkspace.multiModalAgent"),
		...
		social_medium_agent: {
			name: t("components.searchAgentWorkspace.socialMediaAgent"),
