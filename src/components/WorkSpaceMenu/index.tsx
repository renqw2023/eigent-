	...
	const baseWorker: Agent[] = [
		{
			...
			name: t("components.workSpaceMenu.developerAgent"),
		...
		},
		{
			...
			name: t("components.workSpaceMenu.searchAgent"),
			type: "search_agent",
			log: [],
			activeWebviewIds: [],
		},
		{
			...
			name: t("components.workSpaceMenu.multiModalAgent"),
		...
		// 	name: t("components.workSpaceMenu.socialMediaAgent"),
		...
		// },
		{
			...
			name: t("components.workSpaceMenu.documentAgent"),
			type: "document_agent",
			log: [],
			activeWebviewIds: [],
		},
